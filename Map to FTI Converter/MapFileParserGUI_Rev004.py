    ...
    def Process(self):
        ...
        if infile == "":
            ...
            if self.symbolsloaded:
                outputCSV(outfile,Process(infile,self.symbols.getactivelist()),self.menu.SplitLarge.get())
            else:
                outputCSV(outfile,Process(infile,loadSymbols(symfile)),self.menu.SplitLarge.get())
